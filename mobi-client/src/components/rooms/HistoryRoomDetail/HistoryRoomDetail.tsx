...
interface HistoryRoomDetailProps {
  // Props are now received from navigation route params
}
...
const getRelativeTime = (dateString: string) => {
  ...
  if (diffInSeconds < 86400) return `${Math.floor(diffInSeconds / 86400)} ngày trước`;
  if (diffInSeconds < 2592000) return `${Math.floor(diffInSeconds / 2592000)} tháng trước`;
  if (diffInSeconds < 31536000) return `${Math.floor(diffInSeconds / 31536000)} năm trước`;
...
export default function HistoryRoomDetail({}: HistoryRoomDetailProps) {
